...
function Dex() {
  return (
    <div className="bg-[#16081c] lg:px-28 pt-14 px-10 pb-10" id="dex">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div>
            ...
            <h2 className="pt-4 font-semibold xl:text-5xl lg:text-4xl md:text-4xl text-3xl text-white lg:leading-[2.5rem] 2xl:leading-[3.7rem]">
