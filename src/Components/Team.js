...
const Team = () => {
  return (
    <section className='bg-[#110617]' id='team'>
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      ...
      <h1 className="pt-4 font-semibold xl:text-5xl lg:text-4xl md:text-4xl text-3xl text-white lg:leading-[2.5rem] 2xl:leading-[3.7rem]">
          ...
          <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Meet the extremely talented, hard working and intelligent individuals who are an integral part of our team.</p>
      </div> 
